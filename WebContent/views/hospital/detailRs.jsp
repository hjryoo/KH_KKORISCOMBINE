...
<body>
	...
	<div class="container">
		<div class="contents">
			<h2>예약 상세 조회</h2>
			<% if(rs.getRsVisit().equals("Y")){ %>
			<form action="<%= request.getContextPath() %>/select.hp" method="post">
			<% } else { %>
			...
			<% } %>
				...
				<div class="info">
					...
					<input type="hidden" name="rsDate" value="<%= date %>">	
					<div class="button-box"><button id="writeBtn">후기 작성</button></div>
					<% } else{ %>
